...
public class RobotOrbitPoint extends Command {
    ...
    public void execute() {
        ...
        Translation2d pos2 = pos1.getY() > FieldConstants.kFieldHeightMeters / 2 ? FieldUtils.flipBlue(m_point) : FieldUtils.flipRed(m_point); // 2D point on field (adjusted for alliance) 
